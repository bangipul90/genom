#!/bin/bash
REPO="https://raw.githubusercontent.com/bangipul90/genom/refs/heads/main/"
...
cd
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/bangipul90/alpha.v2/refs/heads/main/files/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
